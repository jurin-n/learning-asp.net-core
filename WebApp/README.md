...
docker run -d -p 8080:80 --env ASPNETCORE_ENVIRONMENT=%ASPNETCORE_ENVIRONMENT% --env AWS_ACCESS_KEY_ID=%AWS_ACCESS_KEY_ID% --env AWS_SECRET_ACCESS_KEY=%AWS_SECRET_ACCESS_KEY% --env AWS_REGION=%AWS_REGION% --name myapp webapp
```
